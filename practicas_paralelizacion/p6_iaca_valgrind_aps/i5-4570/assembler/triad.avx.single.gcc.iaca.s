...
triad.avx.single.gcc.iaca:     formato del fichero elf64-x86-64
...
000000000040053c <_start>:
  ...
  400549:	50                   	push   %rax
  40054a:	54                   	push   %rsp
  40054b:	49 c7 c0 90 08 40 00 	mov    $0x400890,%r8
  400552:	48 c7 c1 20 08 40 00 	mov    $0x400820,%rcx
...
0000000000400630 <get_wall_time>:
{
  ...
  40064d:	c5 fb 59 0d 03 03 00 	vmulsd 0x303(%rip),%xmm0,%xmm1        # 400958 <_IO_stdin_used+0xb8>
  400654:	00 
...
0000000000400670 <check>:
  ...
  40068b:	75 f3                	jne    400680 <check+0x10>
    printf("%f \n", sum);
  40068d:	bf a4 08 40 00       	mov    $0x4008a4,%edi
...
00000000004006a0 <init>:
  ...
  4006a5:	c5 fa 10 05 c3 02 00 	vmovss 0x2c3(%rip),%xmm0        # 400970 <_IO_stdin_used+0xd0>
  4006ac:	00 
{
  ...
  4006c0:	c5 fa 10 05 ac 02 00 	vmovss 0x2ac(%rip),%xmm0        # 400974 <_IO_stdin_used+0xd4>
  4006c7:	00 
  ...
  4006de:	75 f0                	jne    4006d0 <init+0x30>
    b[69] = 69.0;
  4006e0:	c5 fa 10 05 90 02 00 	vmovss 0x290(%rip),%xmm0        # 400978 <_IO_stdin_used+0xd8>
  4006e7:	00 
...
0000000000400730 <results>:
{
  ...
  400738:	bf a9 08 40 00       	mov    $0x4008a9,%edi
  40073d:	c5 fb 5e 15 23 02 00 	vdivsd 0x223(%rip),%xmm0,%xmm2        # 400968 <_IO_stdin_used+0xc8>
  400744:	00 
  400745:	c5 fb 5e 0d 13 02 00 	vdivsd 0x213(%rip),%xmm0,%xmm1        # 400960 <_IO_stdin_used+0xc0>
  40074c:	00 
  ...
  400763:	bb 00 00 f0 00       	mov    $0xf00000,%ebx
{
  ...
  400778:	c5 fa 10 0d fc 01 00 	vmovss 0x1fc(%rip),%xmm1        # 40097c <_IO_stdin_used+0xdc>
  40077f:	00 
  400780:	c5 fb 11 44 24 08    	vmovsd %xmm0,0x8(%rsp)
{
  ...
  4007df:	c5 fa 10 0d 95 01 00 	vmovss 0x195(%rip),%xmm1        # 40097c <_IO_stdin_used+0xdc>
  4007e6:	00 
  ...
  4007f6:	bf c3 08 40 00       	mov    $0x4008c3,%edi
  4007fb:	e8 30 ff ff ff       	callq  400730 <results>
    check(a);
  400800:	bf c0 30 60 00       	mov    $0x6030c0,%edi
  400805:	e8 66 fe ff ff       	callq  400670 <check>
}
  40080a:	48 83 c4 10          	add    $0x10,%rsp
...
0000000000400820 <__libc_csu_init>:
  ...
  400831:	4c 8d 25 d0 05 20 00 	lea    0x2005d0(%rip),%r12        # 600e08 <__frame_dummy_init_array_entry>
  400838:	55                   	push   %rbp
  400839:	48 8d 2d d0 05 20 00 	lea    0x2005d0(%rip),%rbp        # 600e10 <__init_array_end>
  400840:	53                   	push   %rbx
  400841:	4c 29 e5             	sub    %r12,%rbp
  400844:	31 db                	xor    %ebx,%ebx
  400846:	48 c1 fd 03          	sar    $0x3,%rbp
  40084a:	48 83 ec 08          	sub    $0x8,%rsp
  40084e:	e8 1d fc ff ff       	callq  400470 <_init>
